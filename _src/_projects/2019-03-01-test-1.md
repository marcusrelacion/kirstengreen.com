...
year: Gartner, 2017-18
description: TalentNeuron is a top source for talent-related data, but we found many of its users were not able to get the most out of its data. This lead us to explore how we provide and display data throughout the platform.
